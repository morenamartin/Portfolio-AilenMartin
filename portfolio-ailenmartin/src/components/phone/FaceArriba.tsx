const FaceArriba = () => {
    return (
        <div className="flex flex-col gap-4">  
            <div className="flex flex-row items-center justify-between w-full gap-2 pt-8">
            ...
            <div className="flex flex-col gap-2">
                <div className="w-full h-1 bg-[#a9a9a9] rounded-full"></div>
                <div className="w-28 h-1 bg-[#a9a9a9] rounded-full"></div>
            </div>
        </div>
    )
}

export default FaceArriba