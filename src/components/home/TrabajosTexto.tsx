...
const TrabajosTexto = () => {  
    return (
        <div className="relative flex flex-col items-center pb-24 mt-28">
            ...
            <h1 className="font- z-20 text-6xl mt-5 -tracking-[4px] text-center">Trabajos</h1>
            <div className="w-[90%] mt-10 text-center ">
                <p className="font- text-[23px] leading-9 -tracking-[1px]">
                ...
                <div className="mt-10 space-y-4 font- text-[28px] -tracking-[2px]">
